    ...
    <Container style={{ width: "50%", margin: "150px auto" }}>
      {status === statusList.success ? (
        <Alert variant="success">
          Registrasi berhasil silahkan <Alert.Link onClick={() => history.push("/login")}>Login</Alert.Link> dengan email dan password anda
        </Alert>
      ) : null}
      <Card>
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formGridName">
                ...
                <Form.Control type="text" isInvalid={errors.full_name} placeholder="Masukan nama lengkap" {...register("full_name")} />
                <Form.Control.Feedback type="invalid">{errors.full_name?.message}</Form.Control.Feedback>
              </Form.Group>

              <Form.Group as={Col} controlId="formGridEmail">
                <Form.Label>Email</Form.Label>
                <Form.Control type="email" placeholder="Masukan email" isInvalid={errors.email} {...register("email")} />
            ...
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formGridPassword">
                ...
                <Form.Control type="password" placeholder="Password" isInvalid={errors.password} {...register("password")} />
                <Form.Control.Feedback type="invalid">{errors.password?.message}</Form.Control.Feedback>
              </Form.Group>

              <Form.Group as={Col} controlId="formGridPasswordConfirmation">
                <Form.Label>Konfirmasi Password</Form.Label>
                <Form.Control type="password" placeholder="Konfirmasi Password" isInvalid={errors.password_confirmation} {...register("password_confirmation")} />
